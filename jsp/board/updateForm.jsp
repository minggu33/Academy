...
<body>
	...
	<% 
		...
		// 글 번호에 해당하는 정보를 가져오는 메서드
		BoardBean bb = bdao.getBoard(num);
		// = bdao.getBoard(num).getNum(); (x) 같은 내용임 하지만 코드가 길어지고 복잡해져서 안씀
	...
	<fieldset>
		...
		비밀번호 : <input type="password" name="pass" placeholder="비밀번호 입력하세요."><br>
