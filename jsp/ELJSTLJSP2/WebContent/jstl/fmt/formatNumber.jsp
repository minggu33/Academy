...
<body>
	...
	<h1>WebContent/jstl/core/formatNumber.jsp</h1>
	...
	3.123123123 소수점 데이터를 소수점 2째자리까지 표현 <br>
	...
	<hr>
	백분율 계산하기(퍼센트 계산) <br>
	<fmt:formatNumber value="0.11274" type="percent"/><br>
	
	<fmt:formatNumber value="0.11274" type="currency"/><br>
	
	<fmt:formatNumber value="0.11274" type="currency" 
						currencySymbol="★"/><br>
