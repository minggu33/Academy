...
/*
	배치 관리자 종류 -> GridLayout 클래스
	 ...
	 - 셀에 왼쪽에서 오른쪽으로, 위쪽에서 아래로 순서대로 배치
	 
*/

// GridLayout 배치관리자 클래스로 입력 폼 만들기 : 4 X 2 그리드로 분할
// JLabel클래스 <---- 텍스트를 표시하기 위한 컴포넌트
...
public class GridLayoutEx extends JFrame{
	...
	public GridLayoutEx(){
		...
		// GridLayout 배치관리자 객체를 프레임창 내부에 부착된 ContentPane 도화지에 설정
		...
		this.add(new JLabel("학과"));  // 학과 텍스트 표시
		this.add(new JTextField("")); // 입력할 수 있는 곳
		
		this.add(new JLabel("과목"));  // 과목 텍스트 표시
		this.add(new JTextField("")); // 입력할 수 있는 곳
