	...
	public static void main(String[] args) {
		...
		switch (myDream) { //myDream변수에 저장되어 있는 값이 
			...
			case "Programmer"://Programmer와 같냐?
				  ...
				  break; // break문을 만나면 그다음 case 유형의 값과 비교하지 않고
				  		 // switch조건문을 완전히 빠져나감
			
			case "Doctor": //Doctor와 같냐?
				System.out.println("나의 꿈이 아닙니다."); // 실행할 명령문
				break;
				
			case "DBA": //DBA와 같냐?
				System.out.println("정답입니당 저는 데이터베이스 관리자가 되고 싶어요.");
				break;
				
			default: //조건 값이 위에 나열된 어떠한 case절의 값에도 해당하지 않을때만
					 // 명령문을 실행합니다.
