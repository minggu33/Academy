...
public class test142 {
	...
	public static void main(String[] args) {
		...
		// System.out : 읽어들인 데이터를 바이트 단위로 모니터화면에 출력하기 위해 사용되는 OutputStream객체
