...
/*
	...
	해설 : '나'라는 객체가 '과일장수' 객체로부터 '사과'객체를 구매하는 동작을 표현
			// [과일장수 객체 관점]
			// -과일장수 객체는 사과를 팝니다. 
			//   -> 팝니다 : 행동(기능)
	
			// -과일장수 객체는 사과20개, 오렌지 10개를 보유하고 있다.
			//  -> 사과 20개, 오렌지 10개 : 데이터(상태)
			
			// 참고 : 데이터(상태)는 변수에 저장
			//        행동(기능)은 메소드로 표현
			
// 객체 지향 프로그래밍 1단계 (현실의 객체 모델링)
		// 과일장수객체 모델링
		// 데이터(상태) : 보유하고 있는 과일 개수 100개, 과일 판매수익 10000원
		// 행동(기능) : 과일 판매 행동
		 
객체 지향 프로그래밍 2단계 클래스 설계
*/

class FruitSeller{//과일 판매자
	
	//사과 한개당 가격을 1000원으로 정해서 상수메모리에 저장
	...
	// 메소드
	//과일 판매하는 행동을 메소드로 선언
	int saleApple(int money) {//과일 구매자가 과일구매시 전달하는 금액을 매개변수로 받음
		//판매한 과일의 개수 구하여 저장
	...
	public void showSaleResult() {
		System.out.println("판매하고 남은 사과 개수 : "+numOfApple);
...
//			[과일 구매자 관점]
//			1단계	나(과일구매자) 모델링
//					데이터 -> 현재 소유하고 있는 10000원, 현재 소유한 과일 수 100개
//					동작(기능) -> 과일구매하기, 과일구매 후 현재 상황을 말할 수 있다.
...
class FruitBuyer{//과일 구매자 클래스 설계
	...
	//현재 소유하고 있는 과일 수를 저장할 변수 선언
	int numOfApple = 0;
	
	//메소드
	//과일 구매하기 행동의 메소드
	//매개변수 선언 -> 과일구매하기 위한 과일판매자 객체를 전달하기 위한 매개변수 선언
	//매개변수 선언 -> 과일구매하기 위한 구매금액을 전달할 매개변수 선언
	public void buyApple(FruitSeller seller,int money) {
		//과일 판매자객체에게 과일을 구매하기위해 매개변수 seller로 전달 받은
		// new FruitSeller()객체의 과일판매행동의 메소드 호출시 구매 금액을 전달함.
...
public class test55 {
	...
	public static void main(String[] args) {
		...
		//과일 구매자는 과일 판매자에게 2000원을 지불하고 과일 구매하기
