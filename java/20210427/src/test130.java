...
public class test130 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 데이터베이스 연결 후 Connection 객체 자원해제 코드를 작성하는 영역
			// 데이터베이스 작업 후 ResultSet 객체의 자원해제 코드를 작성하는 영역
			// 데이터베이스 작업 후 PreparedStatement 객체의 자원해제 코드를 작성하는 영역
