...
public class test129 {
	...
	try {	
		...
		//  -> 예외 발생 당시의 호출스택에 있었던 메소드의 정보와 예외 메세지를 화면(이클립스 Console 탭)에 출력
		//	-> 예외 발생하기 까지의 모든 과정과 예외가 발생한 소스코드의 행 번호를 출력
		// 2. System.out.println( e.getMessage()메소드)
		// 	-> 발생한 예외객체에 저장된 메세지를 간략히 얻을 수 있게 도와주는 메소드
		//	-> 간략한 예외정보만 출력한다.
		e.printStackTrace();
