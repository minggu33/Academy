...
class Test{
	...
	//		- 객체가 생성되어 올라가는 Heap영역의 객체 내부에 변수의 메모리를 할당함.
	int x;
...
public class test70 {
	...
	public static void main(String[] args) {
		...
		// 기존에 있던 클래스변수 y 내부에 저장된 값이 계속 += 누적된다.
		
		// 사실 확인을 위해서 한번 더 객체 생성
		Test t3 = new Test(10);
		System.out.println("Test t3객체");
		// 인스턴스 변수 x에 접근하여 인스턴스변수 x의 값 출력
		System.out.println(t3.x);
		// 클래스 변수 y에 접근하여 클래스변수 y의 값 출력
		// 방법2. 클래스명. 클래스변수명;
		...
		/*
			...
			2. 클래스 변수 y는 생성된 각 객체들이 공유받아서 사용할 목적으로
			   클래스 설계할 때 생각하고 만들어 주어야 한다.
