...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		//변수 생성 및 변수에 값 저장 (변수 선언 및 초기화) 연습하기
			...
			// 4 바이트 크기의 실수 데이터를 저장할 f라는 이름의 변수 메모리 만들기
				float f;
				
			// f변수에 3.14 저장
				f = 3.14F; //float값을 저장할때 3.14F double는 3.14B 또는 3.14
							// 3.14만 적으면 8바이트 크기의 실수값 double로 인식해버림
			...
			// 예) 홍길동 이라는 문자열을 저장할 name이라는 이름의 변수 선언
				String name;
				name = "홍길동";
