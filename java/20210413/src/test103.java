...
abstract class AbstractSuper{ // 부모클래스
	...
	// 일반메소드
	void Method02() {
		System.out.println("Method02: 추상클래스 AbstractSuper에서 구현된 일반메소드");
	}	
}

// 위 Method01 추상메소드를 오버라이딩 하지 않으려면
// MiddleClass 자식클래스를 추상클래스로 만들어야함.
...
public class test103 {
	public static void main(String[] args) {
		...
		// 추상클래스 AbstractSuper로부터 상속받은 일반메소드 호출 가능
		sub.Method02();
		
		// 추상클래스 MiddleClass로부터 상속받은 일반메소드 호출 가능
		sub.Method03();
