...
// ShapeClass1 추상클래스를 상속받는 Circle 자식 일반클래스 만들기
...
// ShapeClass1추상클래스를 상속받는 Rect1자식일반 클래스 만들기
...
public class test104 {
	...
	public static void main(String[] args) {
		...
		// 추상(부모)클래스 타입의 참조변수 ref선언
		// 업캐스팅 -> new Circle()객체 생성 후 저장
		ShapeClass1 ref = new Circle();
		...
		// 		for반복문으로 일괄 처리하더라도 출력 결과가 다르게 된다.
		
		System.out.println("-----------------------------------------");
		
		// static으로 선언한 정적메소드(클래스 메소드) 이기 때문에 
		// 메소드명 put으로 바로 호출가능
		put(new Circle());
		put(new Rect1());
		put(new Tria1());
