	...
	연산자 종류
 	...
 	1. 산술 연산자란?
 		...
 		산술연산자 종류										설명
 			...
 			-						왼쪽의 피연산자에 오른쪽의 피연산자를 빼는 연산자 기호.
...
public class Test8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(5 % 3); // % <-- 나눈 나머지값을 구하는 연산자
	 ...
	 */
		...
		b /= a; // b = b / a; //풀이 : 변수 b에 저장된 값을 변수 a에 저장된 값을 나눈 결과값을 변수 b에 저장함.
		System.out.println(b);
		
		b %= a; // b = b % a; //풀이 : 변수 b에 저장된 값을 변수 a에 저장된 값으로 나눈 나머지 값을 구한 후, 변수 b에 저장함.
		System.out.println(b);
