...
/*
	...
	- 자바프로그램이 원하는 결과를 얻기 위해서 프로그램의 순차적인 흐름을 제어할때 사용하는 명령문
	...
	1. 조건문
		...
		1.1 if문
			- if문은 조건식 결과값이 참(true)이면 주어진 명령문을 실행하며,
...
public class test19 {
	...
	public static void main(String[] args) {
		...
		/*
			1-2. if else문
				...
				설명 : if 조건식의 연산결과가 거짓일때만 else{}중괄호 블럭내의 명령어가 실행됨.
		
				*/
		
		visitCount = 5; //홈페이지에 방문한 방문 횟수
		
		//visitCount변수에 저장되어 있는 값이(홈페이지에 방문한 방문횟수)
		// 1보다 작으면(한번도 방문하지 않았다면)
		if (visitCount < 1) {
			
			System.out.println("처음오셨군요. 방문을 환영합니다.");
	...
	/*
		...
		*/
		...
		//예제. if else if else문을 사용하여 ch변수에 저장된 문자가 
