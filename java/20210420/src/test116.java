...
public class test116 {
	...
	public static void main(String[] args) {
		...
		//    -> 두 객체가 동일한 메모리에 할당 되어 있는지 물어보기 위해 사용
		...
		// c 참조변수에 저장된 객체메모리의 주소와 d참조변수에 저장된 객체메모리의 주소가 같은지 비교		
		if(c == d) {
			System.out.println("같다");
		}else {
			System.out.println("다르다");
		...
		// c 참조변수에 저장된 객체메모리의 주소와 e참조변수에 저장된 객체메모리의 주소가 같은지 비교
		if(c == e) {
			System.out.println("같다");
		}else {
			System.out.println("다르다");
		...
		//	  두 참조변수가 동일한 객체메모리를 가리켜서 참조하고 있는지를 비교한다.
		//	  두 객체 메모리의 주소를 비교한다.
