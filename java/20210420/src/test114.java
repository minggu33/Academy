/*
	...
	3. 명시적으로 특정 자식클래스 extends 특정부모클래스를 상속받지 않으면
	...
	4. Object클래스 내부에 만들어져 있는 자주 사용되는 생성자와 메소드들
	   ...
	   - boolean equals(Object obj)메소드 : 
	     매개변수 obj로 전달받는 객체와 현재객체를 비교하여 같은 객체이면 true리턴
...
class Point /*extends Object*/{
	...
	//		 모든 클래스의 최고 부모클래스인 Object클래스를 상속받은 클래스이다.
	//		 따라서 Object클래스의 모든 메소드를 Point클래스 내부에서 접근해서 사용할 수 있다.
